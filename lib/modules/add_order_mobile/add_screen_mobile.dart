...
class _AddScreenMobileState extends State<AddScreenMobile> {
  ...
  Widget build(BuildContext context) {
    ...
    AppCubit
        ...
        .gift!
        .sublist(0, midPoint);
    List<GiftModel> secondColumn = AppCubit
        .get(context)
        .gift!
        .sublist(midPoint);
    AppCubit
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    ...
                                    child: TextFormField(
                                      ...
                                      textInputAction: TextInputAction.next,
                                      onFieldSubmitted: (_) {
                                        if (cubit.detailsController.text
                                            .isEmpty) {
                                          ...
                                          if (formKey.currentState!
                                            ...
                                            OrderDetailsModel(
                                              ...
                                              total: int.parse(
                                                  cubit.priceController.text)*int.parse(
                                                  cubit.quantityController
                                                      .text),
                                              details: cubit.detailsController
                                                  .text,
                                              price: int.parse(
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                // Data Rows
                                ConditionalBuilder(condition: cubit.giftList.isNotEmpty, builder: (context)=>ListView.builder(
                                    ...
                                    onTap: () {
                                      if (formKeys.currentState!.validate()) {
                                        if (cubit.giftList.isNotEmpty) {
                                          dialog(context, onTap: () {
                                            cubit.addOrder(
                                              phoneTow: cubit.phoneControllerTow
                                                  .text,
                                              name: cubit.nameController.text,
                                              phone: cubit.phoneController.text,
                                              address: cubit.addressController
                                                  .text,
                                              mandobeName: cubit.mandobeValue ??
                                                  "",
                                              code:usermodel!.type == "مسوق الكتروني"?usermodel!.name! :cubit.codeValue ?? "",
                                              total: "${cubit.total}",
                                              dateTime: date.toString(), city: cubit.cityValue!, orderDetails:cubit.giftList,
                                            );
                                            Navigator.pop(context);
                                          },
                                              onCancelTap: () {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          dataCell(cubit.giftList[index].details!.toString(), 5, isEllipsis: true),
          Expanded(
            flex: 2,
            child: IconButton(
              onPressed: () {
