...
class _MyBalanceScreenState extends State<MyBalanceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return  BlocConsumer<AppCubit, AppStats>(
        listener: (context, state) {
          if(state is AddRequestSuccessful){
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text("${usermodel!.totalBalance}",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 40),)
                          ],
                        ),
                      ),
                      const SizedBox(
                      ...
                      Row(
                        ...
                        children: [
                          Expanded(
                            child:  InkWell(
                              onTap: (){
                                _showWithdrawDialog(context, cubit);
                              },
                              child: Container(
                                decoration: BoxDecoration(
                                    color: Colors.white,
  ...
  void _showWithdrawDialog(BuildContext context, AppCubit cubit) {
    showDialog(
      context: context,
                  ...
                  children: [
                    ...
                    TextFormField(
                      ...
                      validator: (value) {
                        ...
                        if (int.parse(value)>usermodel!.totalBalance!) {
                          return "هذا المبلغ اكبر من رصيدك الحالي (${usermodel!.totalBalance!})";
                        }
                        return null;
                      },
